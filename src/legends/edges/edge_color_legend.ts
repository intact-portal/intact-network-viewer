      ...
      this.colors.forEach(color => {
        ...
        switch (trimmedColor) {
          case Constants.EDGE_COLOR_PHYSICAL_ASSOCIATION: {
            const divListElement = this.utility.createDivElementFor(this.PHYSICAL_ASSOCIATION_IMG_URL, Constants.EDGE_COLOR_PHYSICAL_ASSOCIATION_LABEL);
            legendDiv.appendChild(divListElement);
            break;
          }
          case Constants.EDGE_COLOR_ASSOCIATION: {
            const divListElement = this.utility.createDivElementFor(this.ASSOCIATION_IMG_URL, Constants.EDGE_COLOR_ASSOCIATION_LABEL);
            legendDiv.appendChild(divListElement);
            break;
          }
          case Constants.EDGE_COLOR_COLOCALIZATION: {
            const divListElement = this.utility.createDivElementFor(this.COLOCALIZATION_IMG_URL, Constants.EDGE_COLOR_COLOCALIZATION_LABEL);
            legendDiv.appendChild(divListElement);
            break;
          }
          case Constants.EDGE_COLOR_DEPHOSPHORYLATION_REACTION: {
            const divListElement = this.utility.createDivElementFor(this.DEPHOSPHORYLATION_REACTION_IMG_URL, Constants.EDGE_COLOR_DEPHOSPHORYLATION_REACTION_LABEL);
            legendDiv.appendChild(divListElement);
            break;
          }
          case Constants.EDGE_COLOR_DIRECT_INTERACTION: {
            const divListElement = this.utility.createDivElementFor(this.DIRECT_INTERACTION_IMG_URL, Constants.EDGE_COLOR_DIRECT_INTERACTION_LABEL);
            legendDiv.appendChild(divListElement);
            break;
          }
          case Constants.EDGE_COLOR_MUTATION_IN_INTERACTION: {
            const divListElement = this.utility.createDivElementFor(this.MUTATION_IN_INTERACTION_IMG_URL, Constants.EDGE_COLOR_MUTATION_IN_INTERACTION_LABEL);
            legendDiv.appendChild(divListElement);
            break;
          }
          case Constants.EDGE_COLOR_PHOSPHORYLATION_REACTION: {
            const divListElement = this.utility.createDivElementFor(this.PHOSPHORYLATION_REACTION_IMG_URL, Constants.EDGE_COLOR_PHOSPHORYLATION_REACTION_LABEL);
            legendDiv.appendChild(divListElement);
            break;
          }
          case Constants.EDGE_COLOR_OTHERS: {
            const divListElement = this.utility.createDivElementFor(this.OTHERS_IMG_URL, Constants.EDGE_COLOR_OTHERS_LABEL);
            legendDiv.appendChild(divListElement);
            break;
          }
          default: {
