export class Constants {
  ...
  public static NODE_COLOR_CHEMICAL_SYNTHESIS_LABEL = 'Chemical synthesis';
  public static NODE_COLOR_DROSOPHILA_MELANOGASTER_LABEL = 'Drosophila melanogaster';
  public static NODE_COLOR_ESCHERICHIA_COLI_LABEL = 'Escherichia coli';
  ...
  public static EDGE_SINGLE_INTERACTION_COLLAPSED_LABEL: string = 'Single evidence';
  public static EDGE_MULT_INTERACTION_COLLAPSED_LABEL: string = 'Multiple evidence';
